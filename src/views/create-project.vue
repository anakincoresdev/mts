<template>
  <div class="create">
    ...
    <app-select label="Куратор"/>
    <app-select label="Участники"/>
    <app-select label="Начало"/>
    <app-select label="Конец"/>
    <add-button
      @click="openRuleWindow"
      class="create__rule"
    >
      Добавить информационный квант
    </add-button>
      ...
      <div class="create__rule-modal">
        ...
        <div class="rule-modal__fields">
          <app-select
            ...
            label="Параметр"
            @input="changeRuleField($event, 'param')"
